			...
			for (var rn = 0; rn < numRows; rn++) {
				...
				if (rn == 0) {					// FIRST ROW only
					for (var cn = 1; cn <= numColumns; cn++) {
						...
						currentCell.innerHTML = "<input id='"+game+no+"-player"+cn+"name' class='st-playername "+game+no+"-playername' type='text' placeholder='Player "+cn+"' value='"+value+"' onchange='updateMasterScores(\""+game+"\","+no+","+cn+","+rn+",this.value)'>";
					...
					for (var cn = 1; cn <= numColumns; cn++) {
						...
						currentCell.innerHTML = "<input id='"+game+no+"-cell-p"+cn+"r"+rn+"' class='st-scorein "+game+no+"-round"+rn+" "+game+no+"-player"+cn+"' type='text' placeholder='0' value='"+value+"' onchange='updateMasterScores(\""+game+"\","+no+","+cn+","+rn+",this.value,this.id)'>";
					...
					if (rn == 0) {	// FIRST ROW only
						...
						switch (cn) {
							case 0:
								...
								currentCell.innerHTML = "<input class='ist-playername' id='"+game+no+"-player"+rn+"name' type='text' placeholder='Player "+rn+"' value='"+value+"' onchange='updateMasterScores(\""+game+"\","+no+","+rn+",0,this.value)'>";
								break;
							case 1:
