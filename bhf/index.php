    ...
    if ($solved) {
        ...
        echo "<body class='unsolved'>";
            ...
            echo "<div><form id='form-submitanswer' method='post'>";
                echo "<label for='team'>Team #:</label><select name='team' id='team-dropdown'><option value='0'>- - Select your team - -</option><option value='1'>Team 1</option><option value='2'>Team 2</option><option value='3'>Team 3</option><option value='4'>Team 4</option></select>";
